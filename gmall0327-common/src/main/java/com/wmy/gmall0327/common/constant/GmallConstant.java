package com.wmy.gmall0327.common.constant;
...
public class GmallConstant {
    ...
    public static final String KAFKA_TOPIC_USER="GMALL_ORDER_USER";

    public static final String ES_INDEX_ALTER="gmall_alert0327";
